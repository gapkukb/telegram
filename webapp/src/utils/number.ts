...
class Formatter {
   ...
   * ```
   */
  commatize(value: any, precision?: number) {
   ...
   * ```
   */
  currencyfy(value: any, option?: Option) {
   ...
   * ```
   */
  shorten(value: any, option?: Option) {
   ...
   * ```
   */
  percentize(value: any, option?: Option) {
    return this.#excute(this.#percent, value, option);
  }

  #excute(formatter: NumberFormatter, value: any, option?: Option, fillEnd = true) {
